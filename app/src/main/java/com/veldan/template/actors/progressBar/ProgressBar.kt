package com.veldan.template.actors.progressBar
...
import com.veldan.template.utils.ProgressBar as PBar
...
class ProgressBar: AbstractAdvancedGroup() {
    ...
    private val panelMaskGroup  = InvertedMask(SpriteManager.OptionsSprite.PROGRESS_BAR_PROGRESS.data.texture     )
